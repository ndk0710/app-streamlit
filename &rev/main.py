...
if __name__ == '__main__':
    #データ読込み
    specs_info = pd.read_csv("./csv/設備生産能力_10月.csv", encoding='utf-8')
    mounts_info = pd.read_csv("./csv/生産量_26F1.csv", encoding='utf-8')
    units_owned_info = pd.read_csv("./csv/保有設備DB_10月-1.csv", encoding='utf-8')
